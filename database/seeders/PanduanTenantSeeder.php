...
class PanduanTenantSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $guides = [
            ...
            // ==========================================
            // PENGATURAN ZONA WAKTU & TAMPILAN
            // ==========================================
            [
