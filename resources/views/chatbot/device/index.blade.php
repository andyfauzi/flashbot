    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card-premium p-4 h-100 d-flex flex-column">
                ...
                <form action="{{ route('chatbot.device.settings.update') }}" method="POST" class="d-flex flex-column flex-grow-1">
                    @csrf
                    ...
                    <div class="mt-auto pt-3">
                        <button type="submit" class="btn btn-premium btn-premium-brand w-100 py-2">
